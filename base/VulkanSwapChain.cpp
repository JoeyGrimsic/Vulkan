...
#endif
{
  ...
  std::vector<VkFormat> preferredImageFormats = {VK_FORMAT_B8G8R8A8_UNORM, VK_FORMAT_R8G8B8A8_UNORM,
...
void VulkanSwapChain::create(uint32_t &width, uint32_t &height, bool vsync, bool fullscreen) {
  ...
  VkSwapchainCreateInfoKHR swapchainCI{
      ...
      .clipped = VK_TRUE,
      // Setting oldSwapChain to the saved handle of the previous swapchain aids in resource reuse and makes sure that we can
      // still present already acquired images
